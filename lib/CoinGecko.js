...
class CoinGecko {
    ...
    get simple() {
        return {
            ...
            supportedVsCurrencies: () => {
                return _simple.supportedVsCurrencies()
            }
        }
    }
    ...
    get coins() {
        return {
             ...
             */
            list: (params = {}) => {
                return _coins.coinsList(params)
            }
             ...
             */
             ,markets: (params = {}) => {
                return _coins.coinMarkets(params)
            }
             ...
             */
             ,tickersById : (params = {}) => {
                return _coins.tickersById(params)
            }
             ...
             */
             ,historyById : (params = {}) => {
                return _coins.historyById(params)
            }
             ...
             * @returns {ReturnObject}
             */
             ,marketChartById : (params = {}) => {
                return _coins.marketChartById(params)
            }
             ...
             * @returns {ReturnObject} 
             */
             ,marketChartRangeById : (params = {}) => {
                return _coins.marketChartRangeById(params)
            }
             ...
             * @returns {ReturnObject} 
             */
             ,statusUpdateById : (params = {}) => {
                return _coins.statusUpdateById(params)
            }
    ...
    get contract() {
        return {
            getCoinInfo : (params = {}) => {
                return _contract.getCoinInfo(params)
            },
            getMarketChart : (params = {}) => {
                return _contract.getMarketChart(params)
            },
            getMarketChartRange : (params ={}) => {
                return _contract.getMarketChartRange(params)
            }
        }
    }
    ...
    get categories () {
        return {
            ...
            listCategoriesWithMarketData : () => {return _categories.listCategoriesWithMarketData()}
        }
    }
