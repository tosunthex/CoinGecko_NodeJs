...
class CoinGecko {
    ...
    get finance() {
        return {
            financePlatforms : (params = {}) => _financePlatforms.financePlatforms(params),
            financeProducts : (params = {}) => _financePlatforms.financeProducts(params)
        }
    }
    ...
    get index(){
        return{
            ...
            indexesByMarketIdandId : (params = {}) => _indexes.indexesByMarketIdandId(params),
            indexesList : () => _indexes.indexesList()
        }
    }
    ...
    get derivatives(){
        return{
            ...
            derivativesExchanges : (params = {}) => _derivatives.derivativesExchanges(params),
            derivativesExchangesById : (params = {}) => _derivatives.derivativesExchangesById(params),
            derivativesExchangesList : () => _derivatives.derivativesExchangesList()
        }
    }
    ...
    exchangeRates(){
        return _exchangeRates.exchange_Rates()
    }
    ...
    companies(){
        return _companies.CompaniesTreasury()
    }
}
